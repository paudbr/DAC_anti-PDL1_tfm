...
def parse_arguments():
    ...
    parser.add_argument("subdirectory", choices=["Tumor"], help="Subdirectorio a procesar")
...
def call_simiC(directory, subdirectory, l1, l2):
    ...
    p2saved_file = f'/root/workdir/HDAC_tfm/NEW_MAT/{directory}/{subdirectory}/outputSimic/matrices/Output_{subdirectory}_{directory}_all_L1_{l1}_L2_{l2}_2_Ws.pickle'
...
output_pickle = call_simiC(directory, subdirectory, l1, l2)
...
def AUC_filter(directory, subdirectory, l1, l2, filtered_pickle):
    from simiclasso.weighted_AUC_mat import main_fn

    p2df = f'/root/workdir/HDAC_tfm/NEW_MAT/{directory}/{subdirectory}/inputFiles/all_100_1000_subset_matrix.pickle'
    p2AUC = f'/root/workdir/HDAC_tfm/NEW_MAT/{directory}/{subdirectory}/outputSimic/matrices/Output_{subdirectory}_{directory}_all_L1_{l1}_L2_{l2}_2_filtered_AUCs.pickle'

    main_fn(p2df, filtered_pickle, p2AUC)

# Ejecutar la función con la matriz filtrada
AUC_filter(directory, subdirectory, l1, l2, filtered_pickle)
