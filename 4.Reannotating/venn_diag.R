################################################################################
# Title: Venn Diagram of DEGs - Tumor vs Unannotated Cells
# Author: Paula
# Description:
#   This script generates Venn diagrams comparing the set of DEGs between tumor and unannotated 
#   cells
#
#   The script:
#     - Loads DEG files from four treatment comparisons per model.
#     - Extracts unique genes per cell type (Cancer vs Unannotated).
#     - Generates side-by-side Venn diagrams using ggVennDiagram + patchwork.
#     - Saves the final combined plot as PNG.
################################################################################
