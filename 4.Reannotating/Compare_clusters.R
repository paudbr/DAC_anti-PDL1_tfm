################################################################################
# Title: Functional Enrichment Analysis of DEGs in Cancer vs Unannotated Cells
# Author: Paula de Blas Rioja
# Description:
#   This script performs GO, KEGG, and Reactome enrichment analyses on 
#   differentially expressed genes (DEGs) from scRNA-seq data comparing 
#   tumor cells (KPB25L and KPB25L-UV) with unannotated cells under different 
#   treatments: anti-PD-L1, DAC, and DAC+PD-L1 (Combo) (CompareClusters).
#   It includes filtering for strongly upregulated/downregulated genes,
#   conversion to ENTREZ IDs, and generation of barplots for enriched terms.
################################################################################
